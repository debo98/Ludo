        ...
        if (gameObject.getData("type") == "dice" && this.dice.getData("active") == true) {
            ...
            switch (dice_roll) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    this.dice = this.dice4;
                    this.consecutive_sixes = 0;
                    break;
                case 5:
                    this.dice = this.dice5;
                    this.consecutive_sixes = 0;
                    break;
                case 6:
                    this.dice = this.dice6;
                    this.turns_left += 1;
                    this.consecutive_sixes += 1;
                    break;
            }

            console.log(this.turn, "rolled a", dice_roll);
    ...
    can_move() {
        ...
        for (var i = 0; i < 16; i += 1) {
            if (allpieces[i].getData("color") == this.turn) {
                ...
                switch (this.turn) {
                    case "red":
                        if (allpieces[i].getData("pos") + this.dice.getData("facevalue") > 58) cantmove += 1;
                        break;
                    case "blue":
                        if (allpieces[i].getData("pos") + this.dice.getData("facevalue") > 73) cantmove += 1;
                        break;
                    case "green":
                        if (allpieces[i].getData("pos") + this.dice.getData("facevalue") > 63) cantmove += 1;
                        break;
                    case "yellow":
                        if (allpieces[i].getData("pos") + this.dice.getData("facevalue") > 68) cantmove += 1;
                        break;
                }
        ...
        switch (this.turn) {
            ...
            case "blue":
                ...
                break;
            case "green":
                score = this.greenScore;
                break;
            case "yellow":
                score = this.yellowScore;
                break;
        }
        ...
        if (pos == 0 && this.dice.getData("facevalue") == 6) {
            ...
            if (pos == 58) {
                ...
                switch (this.redScore) {
                    case 1:
                        this.score0_red.visible = false;
                        this.score1_red.visible = true;
                        break;
                    case 2:
                        this.score1_red.visible = false;
                        this.score2_red.visible = true;
                        break;
                    case 3:
                        this.score2_red.visible = false;
                        this.score3_red.visible = true;
                        break;
                }
            ...
            if (pos == 73) {
                ...
                switch (this.blueScore) {
                    case 1:
                        this.score0_blue.visible = false;
                        this.score1_blue.visible = true;
                        break;
                    case 2:
                        this.score1_blue.visible = false;
                        this.score2_blue.visible = true;
                        break;
                    case 3:
                        this.score2_blue.visible = false;
                        this.score3_blue.visible = true;
                        break;
                }
            ...
            if (pos == 63) {
                ...
                switch (this.greenScore) {
                    case 1:
                        this.score0_green.visible = false;
                        this.score1_green.visible = true;
                        break;
                    case 2:
                        this.score1_green.visible = false;
                        this.score2_green.visible = true;
                        break;
                    case 3:
                        this.score2_green.visible = false;
                        this.score3_green.visible = true;
                        break;
                }
            ...
            if (pos == 68) {
                ...
                switch (this.yellowScore) {
                    case 1:
                        this.score0_yellow.visible = false;
                        this.score1_yellow.visible = true;
                        break;
                    case 2:
                        this.score1_yellow.visible = false;
                        this.score2_yellow.visible = true;
                        break;
                    case 3:
                        this.score2_yellow.visible = false;
                        this.score3_yellow.visible = true;
                        break;
                }
